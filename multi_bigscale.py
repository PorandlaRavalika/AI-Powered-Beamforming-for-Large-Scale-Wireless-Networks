...
from utils import Q2theta,beamformer_LIS,dtypeconvert,big_scale
...
best_model_path = 'D:/RIS_Project/models/bigscale/best_8_and_32.weights.h5'
...
test_num = 2000 
test_dataset = h5py.File('D:/RIS_Project/data/bigscale/test_dataset_8_and_32.h5','r')
...
print("cvx_theta_test shape or length:", len(cvx_theta_test))
print("test_num:", test_num)
print("G_0_test length:", len(G_0_test))
print("hr_0_test length:", len(hr_0_test))
print("hd_test length:", len(hd_test))
if len(cvx_theta_test) < test_num:
    print("ERROR: cvx_theta_test is too short!")
    print("cvx_theta_test length:", len(cvx_theta_test), "vs test_num:", test_num)
    test_num = len(cvx_theta_test)  # optional fallback fix
...
print("SDR method:%.4f"%cvx_performance)
...
io.savemat('D:/RIS_Project/models/bigscale/best_8_and_32.weights.h5',{'cvx_performance':cvx_performance,\
                                          'un_performance':un_performance,\
                                          'random_performance':random_performance})



# python multi_bigscale.py     
