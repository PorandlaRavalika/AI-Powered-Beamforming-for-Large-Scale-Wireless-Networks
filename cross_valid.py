...
io.savemat('./mat/history.mat',{'train_loss_1':train_loss_1,'train_loss_2':train_loss_2,'train_loss_3':train_loss_3,'val_loss_1':val_loss_1,'val_loss_2':val_loss_2,'val_loss_3':val_loss_3})

#%% history plot
from matplotlib import pyplot as plt
from matplotlib.ticker import MultipleLocator, FormatStrFormatter
history = io.loadmat('./mat/history.mat')
...
# 'ro-'  red,circlemarker,solidline
# 'r^-' red,triangle-up marker,solidline
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('M=8, N=64')
plt.legend(['train loss, BN, batch size 500','train loss,  BN, batch size 5000','train loss,no BN, batch size 5000',
            'val loss, BN, batch size 500','val loss,  BN, batch size 5000','val loss,no BN, batch size 5000'])
